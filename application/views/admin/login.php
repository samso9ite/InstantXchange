	...
	<div id="login">
		<aside>
			<figure>
			  ...
			  <form class="loginForm" method="post" action="<?=site_url('admin/login')?>">
				<div class="access_social">Admin Login</div>
				<div class="form-group">
					<?=$this->session->flashdata('amessage')?>
					<span class="input">
					<input class="input_field" type="text" name="username" required>
						<label class="input_label">
						<span class="input__label-content">Your Username</span>
					</label>
					</span>
				...
				<button type="submit" class="btn_1 rounded full-width login_btn">Login</a>
			</form>
