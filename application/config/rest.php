...
// JWT Exmaple
$config['auth_override_class_method_http']['Login']['index_post']['post'] = 'none';
$config['auth_override_class_method_http']['Auth']['token_refresh']['get'] = 'jwt';
$config['auth_override_class_method_http']['Auth']['token_info']['get'] = 'jwt';
